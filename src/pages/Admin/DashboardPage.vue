  ...
  <div class="admin-dashboard min-h-screen bg-gray-50">
    ...
    <div class="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200">
      <div class="px-4 py-3 flex items-center justify-between">
        ...
        <h1 class="text-lg font-bold text-gray-900">{{ t('Dashboard') }}</h1>
    ...
    <div 
      :class="[
        ...
        'lg:ml-64 lg:pt-0',
        isMobileSidebarOpen ? 'ml-64' : 'ml-0',
        'pt-16 lg:pt-0' // Add padding top for mobile header
      ]"
    >
      <!-- Desktop Header - FIXED AND DOES NOT SCROLL -->
      <div class="hidden lg:block bg-white border-b border-gray-200 fixed top-0 right-0 left-64 z-30">
        <div class="px-6 py-4">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
              ...
              <button 
                ...
                class="p-2 text-gray-600 hover:text-primary-600"
                :title="homepageStore.homepageData.settings.isDarkMode ? t('Switch to Light Mode') : t('Switch to Dark Mode')"
              >
                <svg v-if="homepageStore.homepageData.settings.isDarkMode" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <!-- Main Dashboard Content - WITH EXTRA PADDING FOR FIXED HEADER -->
      <main class="p-4 lg:p-6 lg:pt-24">
        <!-- Loading State -->
        ...
        <!-- Error State -->
        <div v-else-if="homepageStore.error && !homepageStore.homepageData" class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl lg:text-3xl font-bold text-gray-900 mt-1 lg:mt-2">
                  {{ homepageStore.homepageData.featuredBrands.length }}
                </p>
          ...
          <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 lg:p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl lg:text-3xl font-bold text-gray-900 mt-1 lg:mt-2">
                  {{ homepageStore.homepageData.activeOffers.length }}
                </p>
                <p class="text-xs lg:text-sm text-gray-500 mt-1">
          ...
          <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 lg:p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl lg:text-3xl font-bold text-gray-900 mt-1 lg:mt-2">
                  {{ homepageStore.homepageData.heroBanner.imageUrl ? '1' : '0' }}
                </p>
                <p class="text-xs lg:text-sm text-gray-500 mt-1">
                  {{ homepageStore.homepageData.heroBanner.imageUrl ? t('Active') : t('No Banner') }}
                </p>
              </div>
          ...
          <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 lg:p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl lg:text-3xl font-bold text-gray-900 mt-1 lg:mt-2">
                  {{ isSuperAdmin ? authStore.adminUsers.length : homepageStore.homepageData.marqueeBrands.length }}
                </p>
                <p class="text-xs lg:text-sm text-gray-500 mt-1">
        ...
        <div class="grid lg:grid-cols-2 gap-4 lg:gap-6">
            ...
            <div class="p-4 lg:p-6">
              <div class="space-y-4">
                ...
                <div class="relative h-40 lg:h-48 bg-gray-100 rounded-lg overflow-hidden">
                  <img
                    v-if="homepageStore.homepageData.heroBanner?.imageUrl"
                    :src="homepageStore.homepageData.heroBanner.imageUrl"
                    :alt="t('Hero Banner')"
                ...
                <div class="space-y-3">
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-2">
                      <input
                        v-model="homepageStore.homepageData.heroBanner.imageUrl"
                        type="text"
                  ...
                  <div>
                    ...
                    <input
                      v-model="homepageStore.homepageData.heroBanner.title"
                      type="text"
                      class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  ...
                  <div>
                    ...
                    <input
                      v-model="homepageStore.homepageData.heroBanner.subtitle"
                      type="text"
                      class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
          ...
          <!-- Featured Brands Management - WITH INLINE EDITOR -->
          <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            <div class="p-4 lg:p-6 border-b border-gray-200">
              <div class="flex items-center justify-between">
                <h2 class="text-lg font-bold text-gray-900">
            ...
            <div v-if="showBrandsDebug" class="bg-yellow-50 border-b border-yellow-200 p-3">
              ...
              <div class="mt-2 text-xs text-yellow-700">
                <div>Total Brands: {{ homepageStore.homepageData.featuredBrands.length }}</div>
            ...
            <div class="p-4 lg:p-6">
              <div class="space-y-4">
                ...
                <!-- Empty State -->
                <div v-if="homepageStore.homepageData.featuredBrands.length === 0" class="p-8 text-center text-gray-500">
          ...
          <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            ...
            <div class="max-h-80 overflow-y-auto">
              <div 
                v-for="offer in homepageStore.homepageData.activeOffers" 
                :key="offer.id"
              ...
              <!-- Empty State -->
              <div v-if="homepageStore.homepageData.activeOffers.length === 0" class="p-8 text-center text-gray-500">
                <svg class="w-10 h-10 mx-auto mb-2 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" 
                        d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                </svg>
          ...
          <div v-if="!isSuperAdmin" class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            ...
            <div class="p-4 lg:p-6">
              <div class="flex flex-wrap gap-3">
                <div 
                  v-for="brand in homepageStore.homepageData.marqueeBrands" 
                  :key="brand.id"
              ...
              <!-- Empty State -->
              <div v-if="homepageStore.homepageData.marqueeBrands.length === 0" class="py-8 text-center text-gray-500">
                <svg class="w-10 h-10 mx-auto mb-2 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" 
                        d="M13 10V3L4 14h7v7l9-11h-7z"/>
                </svg>
          ...
          <div v-else class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            ...
            <div v-else class="max-h-80 overflow-y-auto">
              ...
              <!-- Empty State -->
              <div v-if="authStore.adminUsers.length === 0" class="p-6 text-center text-gray-500">
                <svg class="w-10 h-10 mx-auto mb-2 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" 
                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-4.5V3m0 0h-3m3 0h3"/>
                </svg>
        ...
        <!-- Quick Actions -->
        <div class="mt-6 lg:mt-8 bg-white rounded-xl shadow-sm p-4 lg:p-6">
...
onMounted(async () => {
  ...
  if (homepageStore.homepageData.settings.isDarkMode) {
...
const loadHomepageData = async () => {
  try {
    ...
    brandFileInputs.value = new Array(homepageStore.homepageData.featuredBrands.length).fill(null)
    console.log('✅ Dashboard loaded with brands:', homepageStore.homepageData.featuredBrands.length)
  } catch (error) {
...
const addNewBrand = () => {
  ...
  homepageStore.homepageData.featuredBrands.push({
    id: newId,
    name: '',
    image: '',
    signature: '',
  ...
  // Add null reference for file input
  brandFileInputs.value.push(null)
  
  showBrandsStatus('success', 'New brand added - Edit the details below')
...
const handleBrandImageUpload = async (event: Event, index: number) => {
  ...
  try {
    ...
    // Upload the image - FIXED: Base64 returns string directly
    const base64Image = await homepageStore.uploadImage(file, 'brands')
    
    // Update the brand image with Base64 string
    homepageStore.homepageData.featuredBrands[index].image = base64Image
...
const removeBrand = async (index: number) => {
  if (homepageStore.homepageData.featuredBrands.length <= 1) {
  ...
  const brandName = homepageStore.homepageData.featuredBrands[index].name || `Brand #${index + 1}`
  homepageStore.homepageData.featuredBrands.splice(index, 1)
...
const saveAllBrands = async () => {
  try {
    ...
    const success = await homepageStore.updateFeaturedBrands(homepageStore.homepageData.featuredBrands)
    if (success) {
...
const updateHeroBanner = async () => {
  try {
    const success = await homepageStore.updateHeroBanner(homepageStore.homepageData.heroBanner)
    if (success) {
...
const handleBannerImageUpload = async (event: Event) => {
  ...
  try {
    ...
    homepageStore.homepageData.heroBanner.imageUrl = base64Image
...
const handleBrandSave = async (brandData: any) => {
  try {
    ...
    if (editingBrand.value) {
      ...
      updatedBrands = homepageStore.homepageData.featuredBrands.map(b => 
        b.id === brandData.id ? { ...brandData } : b
      )
      editingBrand.value = false
    } else {
      // Add new brand
      const newId = Date.now().toString()
      updatedBrands = [...homepageStore.homepageData.featuredBrands, {
        ...brandData,
        id: newId
      }]
    }
...
const handleOfferSave = async (offerData: any) => {
  try {
    ...
    if (editingOffer.value) {
      ...
      updatedOffers = homepageStore.homepageData.activeOffers.map(o => 
      ...
      // Add new offer
      const newId = Date.now().toString()
      updatedOffers = [...homepageStore.homepageData.activeOffers, {
        ...offerData,
        id: newId
      }]
    }
...
const removeOffer = async (id: string) => {
  ...
  try {
    const updatedOffers = homepageStore.homepageData.activeOffers.filter(o => o.id !== id)
    const success = await homepageStore.updateActiveOffers(updatedOffers)
    if (success) {
...
const handleMarqueeBrandSave = async (brandData: any) => {
  try {
    const newId = Date.now().toString()
    const updatedBrands = [...homepageStore.homepageData.marqueeBrands, {
      ...brandData,
      id: newId
    }]
...
const removeMarqueeBrand = async (id: string) => {
  ...
  try {
    const updatedBrands = homepageStore.homepageData.marqueeBrands.filter(b => b.id !== id)
    const success = await homepageStore.updateMarqueeBrands(updatedBrands)
    if (success) {
...
const toggleAdminStatus = async (admin: any) => {
  ...
  try {
    // In a real app, call API to update admin status
...
const handleAdminSave = async (adminData: any) => {
  try {
    // In a real app, call API to create admin
...
// Dark Mode Toggle - Now uses homepage store
const toggleDarkMode = async () => {
  try {
    const newMode = await homepageStore.toggleDarkMode()
    if (newMode) {
      document.documentElement.classList.add('dark')
    } else {
    ...
    alert(t('Failed to toggle dark mode: ') + (error.message || 'Unknown error'))
  }
}
...
/* Ensure main content has enough top padding for fixed header */
main {
  padding-top: 1rem; /* For mobile */
}

@media (min-width: 1024px) {
  main {
    padding-top: 6rem; /* For desktop with fixed header */
  }
}
